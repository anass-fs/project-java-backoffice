   ...
   formatPrice: function(price) {
    ...
    displayUserRole: function() {
        ...
        if (userName) {
            ...
            roleBadge.className = `badge ms-2 ${roleClass}`;
    ...
    applyRoleBasedRestrictions: function() {
        const currentUser = Utils.getCurrentUser();
        if (!currentUser) return;
        ...
        if (currentUser.role === 'User') {
            ...
            const addButtons = document.querySelectorAll('[id$="AddBtn"], [id$="addBtn"]');
            ...
            const modalFooterButtons = document.querySelectorAll('.modal-footer .btn-primary');
            modalFooterButtons.forEach(btn => btn.style.display = 'none');
        }
    },
